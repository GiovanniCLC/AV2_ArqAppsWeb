...
Este projeto foi desenvolvido com base nas documentações oficiais das tecnologias utilizadas e em boas práticas da indústria de desenvolvimento de software.

[1] [Spring Boot Documentation](https://docs.spring.io/spring-boot/docs/current/reference/html) - Documentação oficial do framework Spring Boot, incluindo guias de configuração, segurança e melhores práticas.

[2] [Spring Data JPA Documentation](https://docs.spring.io/spring-data/jpa/docs/current/reference/html) - Guia completo sobre persistência de dados com JPA, incluindo repositórios, queries e relacionamentos entre entidades.

[3] [Spring Security Documentation](https://docs.spring.io/spring-security/reference/index.html) - Documentação oficial sobre implementação de autenticação e autorização em aplicações Spring.

[4] [Springdoc OpenAPI Documentation](https://springdoc.org) - Guia de integração do OpenAPI 3 com Spring Boot para geração automática de documentação Swagger.

[5] [Spring Boot Actuator Documentation](https://docs.spring.io/spring-boot/docs/current/reference/html/actuator.html) - Referência sobre endpoints de monitoramento, métricas e health checks.

[6] [Prometheus Documentation](https://prometheus.io/docs/introduction/overview) - Documentação oficial do sistema de monitoramento Prometheus, incluindo configuração e queries.

[7] [Grafana Documentation](https://grafana.com/docs/grafana/latest) - Guia completo sobre criação de dashboards e visualização de métricas no Grafana.

[8] [Gatling Documentation](https://gatling.io/docs/gatling/reference/current) - Documentação oficial sobre testes de carga e simulações de performance com Gatling.

[9] [React Documentation](https://react.dev/learn) - Documentação oficial do React, incluindo hooks, componentes e gerenciamento de estado.

[10] [Tailwind CSS Documentation](https://tailwindcss.com/docs) - Guia completo sobre o framework CSS utility-first Tailwind.

[11] [Vite Documentation](https://vitejs.dev/guide) - Documentação oficial da ferramenta de build Vite para aplicações frontend modernas.

[12] [Render Deploy Guide](https://render.com/docs/deploy-spring) - Guia oficial para deploy de aplicações Spring Boot no Render.

[13] [Vercel Documentation](https://vercel.com/docs) - Documentação completa sobre deploy e configuração de aplicações no Vercel.
